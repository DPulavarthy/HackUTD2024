        ...
        <div className={`right ${isSplit ? 'split flowset' : ''}`}>
          <div className={`chart-display-container ${isSplit ? 'split animate' : ''}`}>
            <div className="chart-container" id="power">
              <BarChart className="chart" chart_type="power" chart_title="Energy Consumption by Floor" csvFilePath={'/electricity_usage_data_week.csv'} axes={{ 'x': 'Floor', 'y': 'Total Energy Consumed (kWh)' }} graphType="BarChart" stacked="true" filter="true" />
            ...
            <div className="chart-container" id="waste">
              <BarChart className="chart" chart_type="waste" chart_title="Wastage by Floor" csvFilePath={'/wasteData.csv'} axes={{ 'x': 'Floor', 'y': 'Wastage (kg)' }} graphType="LineChart" />
